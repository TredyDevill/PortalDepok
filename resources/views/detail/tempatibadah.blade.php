...
<title>Detail Tempat Ibadah</title>
  ...
  <div class="w3-row-padding">
    ...
    <div id="KD" class="w3-container city w3-medium">
      ...
      <p class="w3-margin-left w3-justify">
        Data ini berisi tentang jumlah data tempat ibadah yang ada di Kota Depok yang di antara lain : Nama, Alamat, Kategori, Kecamatan dan Koordinat Tempat Ibadah</p><br>
    ...
    <script>
      ...
      var ti1 = document.getElementById("dataa");
      ...
      snapshot.forEach(function(ti2){
        ...
        ti1.innerHTML= jmlhti + " <b>Data Jumlah Tempat Ibadah";
      });
      });
    </script>

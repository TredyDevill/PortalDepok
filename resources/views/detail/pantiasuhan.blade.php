...
<title>Detail Panti Asuhan</title>
  ...
  <div class="w3-row-padding">
    <div class="w3-row">
      <a href="javascript:void(0)" onclick="openCity(event, 'T');">
        <div class="w3-half tablink w3-hover-light-grey w3-bottombar w3-padding" style="border-bottom:6px solid rgb(255, 255, 255)">Topik Sosial</div>
      </a>
    ...
    <div id="KD" class="w3-container city w3-medium">
      ...
      <p class="w3-margin-left w3-justify">
        Data ini berisi tentang jumlah data panti asuhan yang ada di Kota Depok.<br>
      ...
      <script>
      var blog = firebase.database().ref("Panti_Asuhan");
      blog.once("value").then(function(snapshot){
        snapshot.forEach(function(childSnapshot){
          var nama = childSnapshot.val().Nama_Panti;
          var alamat = childSnapshot.val().Alamat;

          $("#pa").append('<tr><td>' + nama + '</td><td>' + alamat + '</td></tr>');
        });
      });
      </script>
      <ul class="w3-ul">
        <li class="w3-padding-16">
          ...
          <b><span class="w3-large w3-hover-text-blue">Data Jumlah Panti Asuhan di Kota Depok</span></b></a><br>
    ...
    <script>
      ...
      var pa1 = document.getElementById("dataa");
      ...
      snapshot.forEach(function(pa2){
        jmlhpa++;
        jmlh();
        pa.innerHTML=  " <b>Data Panti Asuhan";
        pa1.innerHTML=  jmlhpa + " <b>Data Jumlah Panti Asuhan";
      });
      });
    </script>
<!-- finish topik -->

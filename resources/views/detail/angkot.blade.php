...
<title>Detail Angkot</title>

@section('content')
  <!-- Header (edited) -->
  <div class="w3-container paddingtop" id="showcase">
    <h2><b> Data Transportasi </b></h2>
  </div>
  ...
  <div class="w3-row-padding">
    <div class="w3-row">
      <a href="javascript:void(0)" onclick="openCity(event, 'T');">
        <div class="w3-half tablink w3-hover-light-grey w3-bottombar w3-padding" style="border-bottom:6px solid rgb(255, 255, 255)">Topik Transportasi</div>
      </a>
    ...
    <div id="KD" class="w3-container city w3-medium">
      ...
      <p class="w3-margin-left w3-justify">
        Data ini berisi tentang jumlah data angkot yang ada di Kota Depok.<br>
        <div class="w3-container">
          <h4>Overview</h4>
          <table class="w3-table w3-bordered">
            <tr>
              <th>Kode Trayek Angkot</th>
              <th>Rute</th>
            </tr>
            <tbody id="akt">
      ...
      <script>
      var blog = firebase.database().ref("Angkot");
      blog.once("value").then(function(snapshot){
        snapshot.forEach(function(childSnapshot){
          var trayek = childSnapshot.val().Kode_Trayek;
          var rute = childSnapshot.val().Rute;

          $("#akt").append('<tr><td>' + trayek + '</td><td>' + rute + '</td></tr>');
        });
      });
      </script>
      <ul class="w3-ul">
        <li class="w3-padding-16">
          ...
          <b><span class="w3-large w3-hover-text-blue">Data Angkot di Kota Depok</span></b></a><br>
    ...
    <script>
      ...
      var a1 = document.getElementById("dataa");
      ...
      snapshot.forEach(function(a2){
        ...
        a1.innerHTML=  jmlha + " <b>Data Jumlah Angkot";
      });
      });
    </script>

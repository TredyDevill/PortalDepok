  ...
  <div class="w3-row-padding">
    ...
    <div id="KD" class="w3-container city w3-medium">
      ...
      <p class="w3-margin-left w3-justify">
        Data ini berisi tentang jumlah data Mall yang ada di Kota Depok.<br>
      ...
      <script>
      var blog = firebase.database().ref("Mall");
      blog.once("value").then(function(snapshot){
        snapshot.forEach(function(childSnapshot){
          var nama = childSnapshot.val().Nama_Mall;
          var alamat = childSnapshot.val().Alamat;

          $("#mall").append('<tr><td>' + nama + '</td><td>' + alamat + '</td></tr>');
        });
      });
      </script>
      <ul class="w3-ul">
        <li class="w3-padding-16">
          ...
          <b><span class="w3-large w3-hover-text-blue">Data Jumlah Mall di Kota Depok</span></b></a><br>
    ...
    <script>
      ...
      var mall1 = document.getElementById("dataa");
      ...
      snapshot.forEach(function(mall2){
        ...
        mall1.innerHTML=  jmlhmall + " <b>Data Jumlah Mall";
      });
      });
    </script>

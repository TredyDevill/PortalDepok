  ...
  <div class="w3-row-padding">
    <div class="w3-row">
      <a href="javascript:void(0)" onclick="openCity(event, 'T');">
        <div class="w3-quarter tablink w3-hover-light-grey w3-bottombar w3-padding" style="border-bottom:6px solid rgb(255, 255, 255)">Topik Pendidikan</div>
      </a>
    ...
    <div id="KD" class="w3-container city w3-medium">
      <br>
      <h3 style="color:#575f8a;"><b>Data Perpustakaan</b></h3>
      <!-- Isi Data -->

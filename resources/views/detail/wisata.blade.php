  ...
  <div class="w3-row-padding">
    ...
    <div id="KD" class="w3-container city w3-medium">
      ...
      <p class="w3-margin-left w3-justify">
        Data ini berisi tentang jumlah data tempat wisata yang ada di Kota Depok.<br>
    ...
    <script>
      ...
      var wst1 = document.getElementById("dataa");
      ...
      snapshot2.forEach(function(wst2){
        ...
        wst1.innerHTML=  jmlhwst + " <b>Data Jumlah Tempat Wisata";
      });
      });
    </script>
<!-- finish topik -->

...
<div class=" bgimg-2 w3-container w3-padding-64" id="about">
  <div class="w3-row w3-content w3-padding-64">
    <div class="w3-col m6 w3-center">
      <img src="images/first-01.png" class="w3-round w3-image" alt="Open Data" width="300" height="300">
    </div>
...
<div class="w3-row w3-center w3-padding-32" id="contact" style="background-color:#575f8a">
  <h3 class="w3-center w3-text-white">Temukan Data Disini<img src="images/icon/map.png" class="w3-circle" style="width:50px;"><br><i class="w3-text-white fa fa-caret-down"></i></h3>
...
<div class="w3-container w3-padding-48" id="work">
  ...
  <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-col l3 m6">
      <a href="link/topik/kesehatan.php">
        <div class="w3-display-container w3-hover-opacity">
          <img src="images/kesehatan.png" style="width:100%" alt="Kesehatan">
    ...
    <div class="w3-col l3 m6">
      <a href="link/topik/pendidikan.php">
        <div class="w3-display-container w3-hover-opacity">
          <img src="images/pendidikan.png" style="width:100%" alt="Pendidikan">
          <div class="w3-display-right w3-display-hover" style="top: 24%; right: 5%;">
    ...
    <div class="w3-col l3 m6">
      <a href="link/topik/pariwisata.php">
        <div class="w3-display-container w3-hover-opacity">
          <img src="images/pariwisata.png" style="width:100%" alt="Pariwisata">
          <div class="w3-display-right w3-display-hover" style="top: 24%; right: 5%;">
    ...
    <div class="w3-col l3 m6">
      <a href="link/topik/keuangan.php">
        <div class="w3-display-container w3-hover-opacity">
          <img src="images/keuangan.png" style="width:100%" alt="Keuangan">
          <div class="w3-display-right w3-display-hover" style="top: 24%; right: 5%;">
  ...
  <div class="w3-row-padding w3-section">
    <div class="w3-col l3 m6">
      <a href="link/topik/bencana.php">
        <div class="w3-display-container w3-hover-opacity">
          <img src="images/bencana.png" style="width:100%" alt="Bencana">
    ...
    <div class="w3-col l3 m6">
      <a href="link/topik/kependudukan.php">
        <div class="w3-display-container w3-hover-opacity">
          <img src="images/kependudukan.png" style="width:100%" alt="Kependudukan">
          <div class="w3-display-right w3-display-hover" style="top: 24%; right: 5%;">
    ...
    <div class="w3-col l3 m6">
      <a href="link/topik/pendidikan.php">
        <div class="w3-display-container w3-hover-opacity">
          <img src="images/pendidikan.png" style="width:100%">
          <div class="w3-display-right w3-display-hover" style="top: 24%; right: 5%;">
            <div class="w3-text-white w3-medium" style="letter-spacing:2px">PENDIDIKAN</div>
          </div>
        </div>
...
<div class="w3-row w3-center" id="contact" style="background-color:#575f8a">
  <img src="images/down-01.png" width="50%">
</div>

<div class="w3-row w3-center" style="background-color: #f1e99d!important;">
  <div class="w3-content" style="max-width:900px;">
  <div class="w3-quarter w3-section">
    <img src="images/logodpk.png" width="200px" height="75px" style="padding-top:1.5em">
  </div>
  <div class="w3-quarter w3-section">
    <img src="images/logodsc.png" width="180px" height="100px">
  </div>
  <div class="w3-quarter w3-section">
    <img src="images/logohidepok.png" width="100px" height="100px">
  </div>
  <div class="w3-quarter w3-section">
    <img src="images/logodepoktik.png" width="160px" height="85px" style="padding-top:1em">
  </div>
  </div>
</div>

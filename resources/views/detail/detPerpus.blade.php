  ...
  <div class="w3-row-padding">
    <div class="w3-row">
      <a href="javascript:void(0)" onclick="openCity(event, 'T');">
        <div class="w3-half tablink w3-hover-light-grey w3-bottombar w3-padding" style="border-bottom:6px solid rgb(255, 255, 255)">Topik Pendidikan</div>
      </a>
    ...
    <div id="KD" class="w3-container city w3-medium">
      ...
      <p class="w3-margin-left w3-justify">
        Data ini berisi tentang jumlah data Perpustakaan yang ada di Kota Depok.<br>
      ...
      <ul class="w3-ul">
        <li class="w3-padding-16">
          ...
          <b><span class="w3-large w3-hover-text-blue">Data Jumlah Perpustakaan di Kota Depok</span></b></a><br>
    ...
    <div id="T" class="w3-container city w3-medium" style="display:none">
      ...
      <script>
        ...
        var perpus1 = document.getElementById("dataa");
        ...
        snapshot.forEach(function(perpus2){
          ...
          perpus1.innerHTML= jmlhperpus + " <b>Data Jumlah Perpustakaan";
        });
        });
      </script>
<!-- finish topik -->
